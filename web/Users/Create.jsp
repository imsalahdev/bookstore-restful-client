...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <form class="custom-form" enctype="multipart/form-data" method="POST" action="${pageContext.servletContext.contextPath}/users">
                    <h2 class="custom-form-title">Add User</h2>
