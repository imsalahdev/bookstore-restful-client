...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../styles/Users/Delete.css" />
    </head>
    <body>
        <header>
            ...
            <div class="container">
                <div class="profile">
                    ...
                    <div class="Value Image">
                        <img src="data:image/png;base64, <%= Base64.getEncoder().encodeToString((byte[]) ((User) pageContext.getAttribute("user")).getPhoto())%>" />
                    </div>
                    ...
                    <div class="Value Button Form-Button">
                        <form method="POST" action="${pageContext.servletContext.contextPath}/users">
                    ...
                    <div class="Value Button">
                        <a href="${pageContext.servletContext.contextPath}/Users">Go Back</a>
                    </div>
                </div>
            </div>
        </main>
