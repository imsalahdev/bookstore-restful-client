    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="table">
                    <div class="tr tb">
                        <a href="${pageContext.servletContext.contextPath}/Users/Create.jsp">Add User</a>
                    </div>
                    <c:forEach var="user" items="<%= UserWS.read()%>">
                        <c:set var="photo" value="${user.photo}" />
                        <div class="tr">
                            <div class="td">
                                <img src="data:image/png;base64, <%= Base64.getEncoder().encodeToString((byte[]) pageContext.getAttribute("photo"))%>" />
                            </div>
                            <div class="td">
                                <div class="tg">
                                    <div class="tk">Username</div>
                                    <div class="tv">${user.username}</div>
                                </div>
                                <div class="tg">
                                    <div class="tk">Email</div>
                                    <div class="tv">${user.email}</div>
                                </div>
                                <div class="tg">
                                    <div class="tk">Password</div>
                                    <div class="tv">${user.password}</div>
                                </div>
                                <div class="tg tl">
                                    <div class="tk">IsAdmin</div>
                                    <div class="tv">${user.isAdmin}</div>
                                </div>
                            </div>
                            <div class="td">
                                <a href="${pageContext.servletContext.contextPath}/Users/Edit.jsp?id=${user.id}">Edit</a>
                                <a href="${pageContext.servletContext.contextPath}/Users/Details.jsp?id=${user.id}">Details</a>
                                <a href="${pageContext.servletContext.contextPath}/Users/Delete.jsp?id=${user.id}">Delete</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
