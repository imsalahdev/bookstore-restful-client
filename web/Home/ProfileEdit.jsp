...
<%
    session.setAttribute("title", "ProfileEdit");
%>
...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <form class="custom-form" action="${pageContext.servletContext.contextPath}/EditProfile" enctype = "multipart/form-data" method="POST">
                    <h2 class="custom-form-title">Edit Profile</h2>
                    <input class="custom-form-input" type="text" name="username" placeholder="Username" value="${user.username}" required>
                    <input class="custom-form-input" type="email" name="email" placeholder="Email" value="${user.email}" required>
                    <input class="custom-form-input" type="password" name="password" placeholder="Password" value="${user.password}" required>
                    <input class="custom-form-file-input" type="file" name="photo">
                    <button class="custom-form-button">Save</button>
                    <a class="custom-form-bottom-link" href="${pageContext.servletContext.contextPath}/Home/ProfileDetails.jsp">Go Back</a>
                </form>
            </div>
        </main>
