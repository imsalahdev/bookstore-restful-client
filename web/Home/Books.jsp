    ...
    <body>
        ...
        <main>
            <div class="home__books">
                <div class="container">
                    <c:choose>
                        <c:when test="<%= request.getParameter("categoryID") != null%>">
                            <c:set var="books" value="<%= BookWS.readByCategoryID(Integer.valueOf(request.getParameter("categoryID")))%>" />
                        </c:when>
                        <c:otherwise>
                            <c:set var="books" value="<%= BookWS.read()%>" />
                        </c:otherwise>
                    </c:choose>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="books pt-5 pb-5">
                                <c:forEach var="book" items="${books}">
                                    ...
                                    <form action="${pageContext.servletContext.contextPath}/Home/Cart.jsp" class="book">
