...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../styles/Home/Register.css" />
    </head>
    <body>
        ...
        <main>
            <div class="container">
                <form class="custom-form" method="POST" enctype="multipart/form-data" action="${pageContext.servletContext.contextPath}/Register">
                    <h2 class="custom-form-title">Sign Up</h2>
                    <p class="custom-form-paragraph">Please fill in this form to create an account!</p>
                    ...
                    <input class="custom-form-file-input" type="file" name="photo" required="required">
                    <button class="custom-form-button">Sign Up</button>
                    <div class="custom-form-hint-text">Already have an account? <a href="${pageContext.servletContext.contextPath}/Home/Login.jsp">Login here</a></div>
                </form>
            </div>
        </main>
