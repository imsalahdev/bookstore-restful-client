...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <form class="custom-form" enctype="multipart/form-data" method="POST" action="${pageContext.servletContext.contextPath}/books">
                    <h2 class="custom-form-title">Add Book</h2>
                    <input type="hidden" name="method" value="POST" />
                    <input class="custom-form-input" type="text" name="title" placeholder="Title" required />
                    <input class="custom-form-input" type="text" name="author" placeholder="Author" required />
                    <input class="custom-form-input" type="text" name="information" placeholder="Information" required />
                    ...
                    <input class="custom-form-input" type="number" name="price" placeholder="Price" required />

                    <input type="file" name="thumbnail" class="custom-form-file-input" required />

                    <input class="custom-form-input" type="number" name="count" placeholder="Count" required />
