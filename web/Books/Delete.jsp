...
<%@page import="dev.salah.beans.Book"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../styles/Books/Delete.css" />
    </head>
    <body>
        <header>
        ...
        <main>
            <div class="container">
                <div class="profile">
                    ...
                    <h4 class="custom-form-title">Are you sure you want to delete this?</h4>
                    <br />
                    <div class="Value Image">
                        <img src="data:image/png;base64, <%= Base64.getEncoder().encodeToString((byte[]) ((Book) pageContext.getAttribute("book")).getThumbnail())%>" />
                    </div>
                    ...
                    <br />
                    <div class="Value">${book.information}</div>
                    <br />
                    <div class="Name">Category</div>
                    <br />
                    <div class="Value">${book.categoryID.name}</div>
                    <br />
                    ...
                    <div class="Value Button Form-Button">
                        <form method="POST" action="${pageContext.servletContext.contextPath}/books">
                    ...
                    <div class="Value Button">
                        <a href="${pageContext.servletContext.contextPath}/Books">Go Back</a>
                    </div>
                </div>
            </div>
        </main>
