...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <form class="custom-form" enctype="multipart/form-data" method="POST" action="${pageContext.servletContext.contextPath}/categories">
                    <h2 class="custom-form-title">Add Category</h2>
                    <input type="hidden" name="method" value="POST" />
                    <input class="custom-form-input" type="text" name="name" placeholder="Name" required />
