...
<%!
    String title = "Categories Dashboard";
        ...
        <main>
            <div class="container">
                <div class="table-category">
                    <div class="tr-category tb-category">
                        <a href="${pageContext.servletContext.contextPath}/Categories/Create.jsp">Add Category</a>
                    </div>
                    <c:forEach var="category" items="<%= CategoryWS.read()%>">
                        <div class="tr-category">
                            <div class="td-category">
                                <div class="tg-category">
                                    <div class="tk-category">Name</div>
                                    <div class="tv-category">${category.name}</div>
                                </div>
                            </div>
                            <div class="td-category">
                                <a href="${pageContext.servletContext.contextPath}/Categories/Edit.jsp?id=${category.id}">Edit</a>
                                <a href="${pageContext.servletContext.contextPath}/Categories/Details.jsp?id=${category.id}">Details</a>
                                <a href="${pageContext.servletContext.contextPath}/Categories/Delete.jsp?id=${category.id}">Delete</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
