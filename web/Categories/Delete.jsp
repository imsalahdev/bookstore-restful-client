...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../styles/Categories/Delete.css" />
    </head>
    <body>
        <header>
            ...
            <div class="container">
                <div class="profile">
                    ...
                    <div class="Value Button Form-Button">
                        <form method="POST" action="${pageContext.servletContext.contextPath}/categories">
                    ...
                    <div class="Value Button">
                        <a href="${pageContext.servletContext.contextPath}/Categories">Go Back</a>
                    </div>
                </div>
            </div>
        </main>
