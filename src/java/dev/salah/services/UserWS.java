...
public class UserWS {
    ...
    public static User read(String email, String password) {
        return builder.fromJson(client.findByCredentials(String.class, email, password), User.class);
    }
    ...
    static class UsersFacadeREST_JerseyClient {
        ...
        public <T> T findByCredentials(Class<T> responseType, String email, String password) throws ClientErrorException {
            WebTarget resource = webTarget;
            resource = resource.path(java.text.MessageFormat.format("credentials/{0}/{1}", new Object[]{email, password}));
